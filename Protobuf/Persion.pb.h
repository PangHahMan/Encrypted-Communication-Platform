...
class Persion :
 ...
 public:
  ...
  const ::phw::Info& info() const;
  ::phw::Info* release_info();
  ::phw::Info* mutable_info();
  void set_allocated_info(::phw::Info* info);
...
inline const ::phw::Info& Persion::info() const {
  const ::phw::Info* p = info_;
  // @@protoc_insertion_point(field_get:itcast.Persion.info)
  return p != nullptr ? *p : *reinterpret_cast<const ::phw::Info*>(
      &::phw::_Info_default_instance_);
}
inline ::phw::Info* Persion::release_info() {
...
inline ::phw::Info* Persion::mutable_info() {
  
  if (info_ == nullptr) {
    auto* p = CreateMaybeMessage<::phw::Info>(GetArenaNoVirtual());
    info_ = p;
  }
  // @@protoc_insertion_point(field_mutable:itcast.Persion.info)
  return info_;
}
inline void Persion::set_allocated_info(::phw::Info* info) {
