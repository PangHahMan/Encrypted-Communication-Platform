...
static void InitDefaultsscc_info_Info_Info_2eproto() {
  ...
  {
    void* ptr = &::phw::_Info_default_instance_;
    new (ptr) ::phw::Info();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::phw::Info::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_Info_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::phw::Info, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::phw::Info, address_),
  PROTOBUF_FIELD_OFFSET(::phw::Info, number_),
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::phw::_Info_default_instance_),
};

const char descriptor_table_protodef_Info_2eproto[] =
  "\n\nInfo.proto\022\003phw\"\'\n\004Info\022\017\n\007address\030\001 \001"
...
Info::Info()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:phw.Info)
}
Info::Info(const Info& from)
  ...
  // @@protoc_insertion_point(copy_constructor:phw.Info)
}
...
Info::~Info() {
  // @@protoc_insertion_point(destructor:phw.Info)
  SharedDtor();
}
...
void Info::Clear() {
// @@protoc_insertion_point(message_clear_start:phw.Info)
...
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ::PROTOBUF_NAMESPACE_ID::uint32 tag;
  // @@protoc_insertion_point(parse_start:phw.Info)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:phw.Info)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:phw.Info)
  return false;
#undef DO_
}
...
void Info::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:phw.Info)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:phw.Info)
}

::PROTOBUF_NAMESPACE_ID::uint8* Info::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:phw.Info)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:phw.Info)
  return target;
}

size_t Info::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:phw.Info)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:phw.Info)
  GOOGLE_DCHECK_NE(&from, this);
  const Info* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Info>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:phw.Info)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:phw.Info)
    MergeFrom(*source);
  }
}

void Info::MergeFrom(const Info& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:phw.Info)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:phw.Info)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:phw.Info)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::phw::Info* Arena::CreateMaybeMessage< ::phw::Info >(Arena* arena) {
  return Arena::CreateInternal< ::phw::Info >(arena);
}
