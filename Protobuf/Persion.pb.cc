...
const char descriptor_table_protodef_Persion_2eproto[] =
  ...
  "st.Color\022\027\n\004info\030\006 \001(\0132\t.phw.Info*%\n\005Col"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Persion_2eproto = {
  &descriptor_table_Persion_2eproto_initialized, descriptor_table_protodef_Persion_2eproto, "Persion.proto", 200,
...
void Persion::InitAsDefaultInstance() {
  ::itcast::_Persion_default_instance_._instance.get_mutable()->info_ = const_cast< ::phw::Info*>(
      ::phw::Info::internal_default_instance());
}
class Persion::HasBitSetters {
 public:
  static const ::phw::Info& info(const Persion* msg);
};
...
// @@protoc_insertion_point(class_specific_merge_from_start:itcast.Persion)
  ...
  if (from.has_info()) {
    mutable_info()->::phw::Info::MergeFrom(from.info());
  }
  if (from.id() != 0) {
    set_id(from.id());
  }
