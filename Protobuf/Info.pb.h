...
PROTOBUF_NAMESPACE_OPEN
template<> ::phw::Info* Arena::CreateMaybeMessage<::phw::Info>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace phw {
...
class Info :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:phw.Info) */ {
 public:
  Info();
  virtual ~Info();
  ...
  // @@protoc_insertion_point(class_scope:phw.Info)
 private:
  class HasBitSetters;
...
inline const std::string& Info::address() const {
  // @@protoc_insertion_point(field_get:phw.Info.address)
...
inline void Info::set_address(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:phw.Info.address)
}
inline void Info::set_address(std::string&& value) {
  
  address_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:phw.Info.address)
}
inline void Info::set_address(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:phw.Info.address)
}
inline void Info::set_address(const void* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:phw.Info.address)
}
inline std::string* Info::mutable_address() {
  
  // @@protoc_insertion_point(field_mutable:phw.Info.address)
...
inline std::string* Info::release_address() {
  // @@protoc_insertion_point(field_release:phw.Info.address)
...
inline void Info::set_allocated_address(std::string* address) {
  ...
  // @@protoc_insertion_point(field_set_allocated:phw.Info.address)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Info::number() const {
  // @@protoc_insertion_point(field_get:phw.Info.number)
  return number_;
}
inline void Info::set_number(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  number_ = value;
  // @@protoc_insertion_point(field_set:phw.Info.number)
}
